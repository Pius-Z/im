...
import com.pius.im.common.model.message.StoreGroupMessageDto;
...
public class StoreGroupMessageReceiver {
    ...
    @RabbitListener(
            bindings = @QueueBinding(
                    ...
                    exchange = @Exchange(value = Constants.RabbitMQConstants.StoreGroupMessage)
            ), concurrency = "1"
    )
    public void onChatMessage(@Payload Message message,
        ...
        try {
            ...
            StoreGroupMessageDto storeGroupMessageDto = jsonObject.toJavaObject(StoreGroupMessageDto.class);
            ImMessageBodyEntity imMessageBodyEntity = jsonObject.getObject("messageBody", ImMessageBodyEntity.class);
            storeMessageService.storeGroupMessage(storeGroupMessageDto.getGroupChatMessageContent(), imMessageBodyEntity);
